...
conn = psycopg2.connect('host=hysen user=hysen password=2140321maya dbname=sportschool')
cur = conn.cursor()
...
# enkele voorbelden van fonts try it!
font1 = "Gill Sans MT", "16" ,"normal", "roman"
font2 = "Gill Sans MT", "50" ,"normal", "roman"
font3 = "Gill Sans MT", "30" ,"normal", "roman"
font4 = "Gill Sans MT", "20" ,"normal", "roman"

root = Tk()
root.winfo_screenwidth()
root.winfo_screenheight()

root.geometry("960x540+-6+0")

C = Canvas(root, bg="black", height=2400, width=1200 )
...
def opslaan_gegevens():
    ...
    if klik == 'yes':
        ...
        #if '1' or '2' or'3'or'4'or'5'or'6'or'7'or'8'or'9'or'0' in De_naam:
        #	showerror('Error', 'Er staat een fout in de voornaam')
        #else:
        #	De_Achternaam =  str(gegeven_naam2.get()).lower()
        #	if '1' or '2'or'3'or'4'or'5'or'6'or'7'or'8'or'9'or'0' or ' ' or '' in De_Achternaam:
        ...
        #					if 'a' or 'b' or 'c' or 'd' or 'e' or 'f' or 'g' or 'h' or 'i' or 'j' or 'k' or 'l' or 'm' or 'n' or 'o' or 'p' or 'q' or 'r' or 's' or 't' or 'u' or 'v' or 'w' or 'x' or 'y' or 'z' or '' or ' ' in De_geboortedatum:
        #						showerror('Error', 'Er staat een fout in de Postcode')
        #					else:
        #						De_telfoon = str(gegeven_telefoonnummer.get()).lower()
        #						if 'a' or 'b' or 'c' or 'd' or 'e' or 'f' or 'g' or 'h' or 'i' or 'j' or 'k' or 'l' or 'm' or 'n' or 'o' or 'p' or 'q' or 'r' or 's' or 't' or 'u' or 'v' or 'w' or 'x' or 'y' or 'z' or '' in De_telfoon:
...
def betaald():
    ...
    add_klant(k_id, De_naam, De_Achternaam , Man_Vrouw, De_geboortedatum, Het_email, De_telfoon, Datum_inschrijving)
    cur.close()
    conn.close()
    klaar()
...
#De eerste scherm
afscheiding = Label(C, text ="---------------------Persoonlijke Informatie------------------------", bg = "black", fg = "white")
afscheiding.config(font=(44))

label1 = Label(C, text ="Voornaam",bg = "black", fg ="white" )
label1.config(font=(44))

label2 = Label(C, text = "Achternaam", bg ="black", fg = "white")
label2.config(font=(44))

label13 = Label(C, text= "Geboortedatum",bg="black", fg='white')
label13.config(font=(44))

label3 = Label(C, text = "Postcode", bg = "black" , fg = "white")
label3.config(font=(44))

label4 = Label(C, text = "Straatnaam + Huisnummer", bg= "black", fg = "white")
label4.config(font=(44))

label5 = Label(C, text = "Woonplaats", bg= "black", fg = "white")
label5.config(font=(44))

label7 = Label(C,text= "E-mail", bg='black', fg='white')
label7.config(font=(44))

label14 = Label(C, text= "Telefoonnummer",bg="black", fg='white')
label14.config(font=(44))

label6 = Label(C, text = "Met welke betaalmethode wilt u betalen?", bg="black", fg= "white")
label6.config(font=(44))

#De tweede scherm
label11  = Label(C, text = "----------------------Overige Informatie------------------------",bg="black", fg='white')
label11.config(font=(44))

label12 = Label(C, text= "Wat is uw geslacht?",bg="black", fg='white')
label12.config(font=(44))

label9 = Label(C, text = 'Hoeveel weegt u? (KG)',bg="black", fg='white')
label9.config(font=(44))

label10  = Label(C, text = "Wat is uw lengte? (m)",bg="black", fg='white')
label10.config(font=(44))

#?????
label8 = Label(C,text= "Scan uw pasje nu.", bg='black', fg='white')
...
C.create_window(350,100, anchor= "w", window= label1)
...
C.create_window(350,160, anchor= 'w', window=label13)
C.create_window(500, 190, anchor="w", window = postcodeinput)
C.create_window(350,190, anchor= "w", window= label3)
C.create_window(500, 220, anchor="w", window = straatinput)
C.create_window(223,220,anchor= "w", window= label4)
C.create_window(500, 250, anchor="w", window = woonplaatsinput)
C.create_window(350,250,anchor= "w", window= label5)
C.create_window(500, 280, anchor='w', window = Emailinput)
C.create_window(350,280, anchor= 'w', window=label7)
C.create_window(500, 310, anchor="w", window = telefoonnummerinput)
C.create_window(350,310, anchor= 'w', window=label14)
C.create_window(550, 480, anchor= "n", window= klaarknop)
