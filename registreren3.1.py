...
def add_person(klant_id, voornaam, achternaam, geslacht, emailadres, postcode ,straat, woontplaats,lengte , gewicht, datuminschrijving):
    query = """
    INSERT INTO
        klant
    VALUES
    ...
    """
    values = (klant_id, voornaam, achternaam, geslacht, emailadres, postcode ,straat, woontplaats,lengte , gewicht, datuminschrijving)
...
def betaald():
    ...
    while run:
        ...
        if not error:
            ...
            break
    print(k_id)
    add_person(k_id, De_naam, De_Achternaam , Man_Vrouw, Het_email, Adres2 ,Adres1, Adres3, De_lengte , Gewicht, Datum_inschrijving)
    cur.close()
    conn.close()
    klaar()
